...
from methyl_chla.DefaultModels import DefaultModels
...
class TrainModels():
    ...
    def build_model(self, model_info):
        ...
        if model_info['model_type_string'].upper() == 'KNN':
            ...
            raise ValueError(f"Unsupported model type string: {model_type_string}. Check build_model function to see accepted strings")
